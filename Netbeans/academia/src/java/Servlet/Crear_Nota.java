 ...
 * @author Julio
 */
@WebServlet(name = "Crear_Nota", urlPatterns = {"/Crear_Nota"})
public class Crear_Nota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(objNota.GetRegistrarNota(codigo, nota1, nota2, nota3)) {
            String redirectURL="registrar_notas.jsp";
